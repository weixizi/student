    ...
    <div class="container-fluid"> <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${user!=null}">
                    <li><a href="javascript:;">欢迎: <span class="text-danger">${user.name}</span></a></li>
                    <a href="${pageContext.request.contextPath}/t-user/exit" target="_top" type="button" class="btn btn-danger navbar-btn">退出</a>
                </c:if>
