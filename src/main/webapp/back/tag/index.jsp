...
<div class="container-fluid">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <c:forEach items="${tags}" var="tag">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/t-tag/deletebyid?id=${tag.id}" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="${pageContext.request.contextPath}/t-tag/save" method="post" id="inputForm" class="form-inline">
