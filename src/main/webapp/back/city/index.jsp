...
<div class="container-fluid">
            ...
            <table class="table table-striped table-bordered table-hover" >
                ...
                <c:forEach items="${cities}" var="city">
                    <tr>
                        ...
                        <td>${city.numbers}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/t-city/deletebyid?id=${city.id}" class="btn btn-danger btn-sm">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form class="form-inline" id="inputForm" action="${pageContext.request.contextPath}/t-city/save" method="post">
