...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/t-student/save" method="post">
...
<script>
    $(function () {
        //1.发送ajax请求查询所有城市信息
        $.get("${pageContext.request.contextPath}/t-city/findAllJSON",function(res){
            console.log(res);
            //遍历城市信息
        ...
        //2.发送ajax请求查询所有班级信息
        $.get("${pageContext.request.contextPath}/t-clazz/findAllClazzJSON",function(clazzs){
        ...
        $("#clazz").change(function(){
            //清空上一次小组信息
            $("#group").empty();
            $.get("${pageContext.request.contextPath}/t-group/findByClazzId",{id:$(this).val()},function(res){
        ...
        $.get("${pageContext.request.contextPath}/t-tag/studentlist",function(tags){
            console.log(tags);
