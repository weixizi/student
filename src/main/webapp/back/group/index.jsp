...
<div class="container-fluid">
                ...
                <c:forEach items="${groups}" var="group">
                    <c:if test="${not empty group.id}">
                        <tr>
                            ...
                            <td>${group.tagname}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/t-group/deletebyid?id=${group.id}" class="btn btn-danger">删除</a>
                            </td>
                        </tr>
                    </c:if>
                </c:forEach>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="inputForm" class="form-inline" action="${pageContext.request.contextPath}/t-group/save" method="post">
                ...
                <div class="form-group">
                    <label>选择班级:</label>
                    <select name="clazzname" class="form-control" id="clazzname">
                        <c:forEach items="${groups}" var="group">
                            <option id="${group.clazzname}">${group.clazzname}</option>
                        </c:forEach>
                    </select>
                </div>
